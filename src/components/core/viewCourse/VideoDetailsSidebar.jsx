    ...
    <>
      ...
      <div className="md:hidden ">
        <div onClick={toggleMobileMenu} className="text-white ">
          {!isMobileMenuOpen && <MdMenuOpen size={30} />}
        </div>

        {isMobileMenuOpen && (
          <div className=" fixed z-[1000]  flex h-[calc(100vh-3.5rem)] w-[220px] max-w-[350px] flex-col border-r-[1px] border-r-richblack-700 bg-richblack-800">
            <div onClick={toggleMobileMenu} className="text-white">
              <IoClose size={30} />
            </div>
